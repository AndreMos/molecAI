...
class MultiMod(pl.LightningModule):
    def __init__(self, batch_size=32, hidden_s=64):
        ...
        self.mm_transformer = Helper(
            self.config_MM, encoder=self.rbf, transformer=self.bert
        )
    ...
    def forward(self, sample):
        ...
        res = self.mm_transformer(
            input_modal=sample.distances_padded.reshape(self.batch_size, -1),
